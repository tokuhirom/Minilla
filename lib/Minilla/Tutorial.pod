...
Alternatively, if you prefer to use GitLab you can create a project in thier web interface and follow the instructions it provides to I<Push an existing Git repository>.
